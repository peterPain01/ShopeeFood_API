...
router.get(
    "/all",
    validateGetShopInfo,
    errorHandler(ShopController.getInfoOFAllShop)
);
router.get(
...
router.get(
    "/top-rated",
    validateGetShopInfo,
    errorHandler(ShopController.getTopRatedShops)
);
router.get(
    "/detail",
    validateGetShopInfo,
    errorHandler(ShopController.getShopInfo)
);
...
router.post(
    "/product",
    [uploadShop.single("product_thumb"), validateCreateProduct],
